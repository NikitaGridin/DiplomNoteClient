...
const PopularAlbuns = observer(() => {
  ...
  const handleChangePart = async () => {
    try {
      const { data } = await axios.get(`${import.meta.env.VITE_BACKEND_URL}album/mostListenedAlbumsInCurrentWeek/${currentPart}`);
  ...
  return (
    <div className='mb-[120px]'>
      ...
      <h1 className='font-bold text-2xl mb-7'>Новинки недели</h1>
